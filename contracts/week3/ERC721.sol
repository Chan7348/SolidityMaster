...
abstract contract ERC721 is Ownable, ERC165, IERC721 {
    ...
    function safeTransferFrom(address _from, address _to, uint _tokenId, bytes memory data) public virtual payable {
    ...
    /// @param _to The new owner
    /// @param _tokenId The NFT to transfer
    function safeTransferFrom(address _from, address _to, uint _tokenId) public virtual payable {
    ...
    /// @param _to The new owner
    /// @param _tokenId The NFT to transfer
    function transferFrom(address _from, address _to, uint _tokenId) public virtual payable {
    ...
    function approve(address _approved, uint _tokenId) public virtual payable {
